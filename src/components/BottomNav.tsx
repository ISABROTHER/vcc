  ...
  return (
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 md:hidden bg-white border-t border-slate-300 shadow-[0_-6px_20px_rgba(0,0,0,0.12)]">
        <div className="mx-auto max-w-5xl px-2 py-2" style={{ paddingBottom: 'env(safe-area-inset-bottom, 6px)' }}>
            ...
            {quickItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={active ? 'font-semibold text-slate-950' : 'text-slate-900'}>
                    {item.label}
                  </span>
                </Link>
              );
      ...
      {isMenuOpen && (
        <>
          ...
          {/* Bottom sheet */}
          <div
            className="fixed inset-x-0 bottom-0 z-50 h-[55vh] bg-white rounded-t-3xl shadow-2xl animate-slideUp"
          >
            {/* Header */}
            ...
            {/* Scrollable Menu */}
            <div className="overflow-y-auto h-[calc(55vh-60px)] px-5 pt-3 pb-8">
